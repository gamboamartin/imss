...
class im_registro_patronal extends modelo{
    ...
    public function alta_bd(): array|stdClass
    {
        ...
        $keys = array('fc_csd_id','im_clase_riesgo_id','cat_sat_isn_id');
        ...
        if(!isset($this->registro['em_clase_riesgo_id'])){
    ...
    public function modifica_bd(array $registro, int $id, bool $reactiva = false): array|stdClass
    {
        ...
        if(!isset($registro['em_clase_riesgo_id'])){
            $registro['em_clase_riesgo_id'] = $registro['im_clase_riesgo_id'];
        }
